...
console.log("Rendering PlacementCard with data:", data);
  return (
    <Card
      elevation={0}
      ...
      <Paper elevation={1} sx={{ borderRadius: "0 0 16px 16px" }}>
        <CardContent sx={{ p: 3 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <InfoItem
                  icon={Email}
                  label="Email"
                  value={data.consultantEmail || data?.candidateEmailId}
                />
              </Grid>
              <Grid item xs={12} md={6}>
                <InfoItem icon={Phone} label="Phone" value={data.phone || data?.candidateContactNo} />
              </Grid>
            </Grid>
          </Section>
          ...
          <Section title="PLACEMENT DETAILS" icon={Business}>
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <InfoItem icon={Business} label="Client" value={data.clientName} />
              </Grid>
              <Grid item xs={12} md={6}>
              ...
              <Grid item xs={12} md={6}>
                <InfoItem
                  icon={PermIdentity}
                  label="Recruiter"
                  value={data.recruiter || data?.recruiterName}
                />
              </Grid>
              <Grid item xs={12} md={6}>
                <InfoItem
