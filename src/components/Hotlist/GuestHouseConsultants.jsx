...
const GuestHouseConsultants = React.memo(() => {
  ...
  const [filters, setFilters] = useState(() => {
    try {
      const stored = localStorage.getItem("guesthouse_hotlist_filters");
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Use guest house specific API endpoint
      const result = await hotlistAPI.getGuestHouseConsultants?.(params) || 
...
export default GuestHouseConsultants;